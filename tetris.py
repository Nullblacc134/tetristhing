...
class Text:
    ...
    def time(self):
        ...
        for x in range(timer, 0, -1):
            ...
            hours = int(x / 3600)
    def draw(self):
        self.font.render_to(self.app.screen, (WIN_W * 0.1, WIN_H * 0.02),
                            text='TETRIS', fgcolor=self.get_color(),
                            size=TILE_SIZE * 0.65, bgcolor=(24, 89, 117))
        self.font.render_to(self.app.screen, (WIN_W * 0.65, WIN_H * 0.22),
                            text='next', fgcolor='black',
                            size=TILE_SIZE * 1.4, bgcolor=(24, 89, 117))
        ...
        self.font.render_to(self.app.screen, (WIN_W * 0.64, WIN_H * 0.8),
                            ...
                            size=TILE_SIZE * 1.8)
        self.font.render_to(self.app.screen, (WIN_W * 0.7, WIN_H * 0.02),
                            text='TIME: ', fgcolor=self.get_color(),
                            size=TILE_SIZE * 0.65, bgcolor=(24, 89, 117))
...
class Tetris:
    ...
    def control(self, pressed_key):
        ...
        if pressed_key == pg.K_RIGHT or pressed_key == pg.K_d:
            self.tetromino.move(direction='right')
        if pressed_key == pg.K_UP or pressed_key == pg.K_w:
            self.tetromino.rotate()
        if pressed_key == pg.K_DOWN or pressed_key == pg.K_s:
            self.speed_up = True
